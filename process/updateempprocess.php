...
// {
	...
	// $id_original = mysqli_real_escape_string($conn, $_POST['id']);
	// $name_update = mysqli_real_escape_string($conn, $_POST['name']);
	// $father_name_update = mysqli_real_escape_string($conn, $_POST['father_name']);
	// $designation_id_update = mysqli_real_escape_string($conn, $_POST['Designation']);
	// $birthday_update = mysqli_real_escape_string($conn, $_POST['birthday']);
	// $gender_update = mysqli_real_escape_string($conn, $_POST['gender']);
	// $contact_update = mysqli_real_escape_string($conn, $_POST['contact']);
	// $address_update = mysqli_real_escape_string($conn, $_POST['address']);
	// $name_of_jail_id_update = mysqli_real_escape_string($conn, $_POST['name_of_jail']);
	// $cnic_update = mysqli_real_escape_string($conn, $_POST['cnic']);
	// $personal_no_update = mysqli_real_escape_string($conn, $_POST['personal_no']);
	// $degree_update = mysqli_real_escape_string($conn, $_POST['degree']);
...
//    echo print_r($name_of_jail_id_update);
    ...
    $emp_update_query ="UPDATE `employee_records` SET `Personal_no`='$personal_no_update',`Cnic`='$cnic_update',`Name`='$name_update',`Father_name`='$father_name_update',`Dob`='$birthday_update',`Contact`='$contact_update',`Address`='$address_update',`Qualification`='$degree_update' WHERE E_id=$id_original";
